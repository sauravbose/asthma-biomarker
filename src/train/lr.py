...
if class_balance_method == 'class_weight':
    param_space = {'penalty':hp.choice('penalty',['elasticnet']),
                   'l1_ratio': hp.choice('l1_ratio', [hp.uniform('l1_ratio_1', 0, 1),hp.choice('l1_ratio_2', [0,1])]),
...
def logistic_objective(params):
    clf = LogisticRegression(random_state = 927364913, **params)
